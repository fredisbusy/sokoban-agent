...
`src/sokoban_agent/graph/agentic/builder.py`에 정의되어 있습니다.
...
├── planning/
│   ├── search/        # BFS/A*와 공간 탐색
│   ├── llm/           # 모델 client와 원시 행동 Planner
│   ├── guards/        # 탐색 기반 검증·fallback
│   ├── agentic/       # 보드 분석, 전략 계약, 단일 push 접지
